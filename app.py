...
def processar():
    ...
    relatorio1 = ", ".join(partes1) + f", alocados direto na {filial}, para atender demandas de copa e cozinha, referente a Janeiro/2026 - NF{nf_num} Fornecedor Coletar."
    ...
    relatorio2 = ", ".join(partes2) + f", alocados direto na {filial}, para atender demandas de limpeza, referente a Janeiro/2026 - NF{nf_num} Fornecedor Coletar."
